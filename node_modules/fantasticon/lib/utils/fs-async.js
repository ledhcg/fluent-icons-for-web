...
exports.checkPath = exports.stat = exports.writeFile = exports.readFile = void 0;
...
const checkPath = (filepath, type) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, exports.stat)(filepath);
        if (type) {
